...
interface SenderPopoverProps {
  record: any;
  handleViewSender: (id: number) => void;
  handleOpenDeleteModal: (id: number) => void;
  handleEditSender: (id: number) => void;
  isPopoverOpen?: (isPopoverOpen: boolean) => void;
}

const SenderPopover: React.FC<SenderPopoverProps> = ({
  record,
  handleViewSender,
  ...
  return (
    <>
      ...
      >
        ...
        >
          <Button
            onClick={() => handleViewSender(record._id)}
            variant="outlined"
