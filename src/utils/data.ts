...
export const countries: readonly CountryType[] = [
  ...
  { code: "AS", label: "American Samoa", phone: "1684", currency: "USD" },
  { code: "AD", label: "Andorra", phone: "376", currency: "EUR" },
  { code: "AO", label: "Angola", phone: "244", currency: "AOA" },
  { code: "AI", label: "Anguilla", phone: "1264", currency: "XCD" },
  { code: "AQ", label: "Antarctica", phone: "672", currency: "N/A" },
  ...
  { code: "AW", label: "Aruba", phone: "297", currency: "AWG" },
  ...
  { code: "BS", label: "Bahamas", phone: "1242", currency: "BSD" },
  { code: "BH", label: "Bahrain", phone: "973", currency: "BHD" },
  { code: "BD", label: "Bangladesh", phone: "880", currency: "BDT" },
  { code: "BB", label: "Barbados", phone: "1246", currency: "BBD" },
  ...
  { code: "BM", label: "Bermuda", phone: "1441", currency: "BMD" },
  ...
  { code: "KY", label: "Cayman Islands", phone: "1345", currency: "KYD" },
  {
    code: "CF",
  ...
  { code: "CG", label: "Congo", phone: "242", currency: "XAF" },
  {
    code: "CD",
  ...
  { code: "DM", label: "Dominica", phone: "1767", currency: "XCD" },
  ...
  { code: "GD", label: "Grenada", phone: "1473", currency: "XCD" },
  { code: "GU", label: "Guam", phone: "1671", currency: "USD" },
  ...
  { code: "IR", label: "Iran", phone: "98", currency: "IRR" },
  ...
  { code: "JM", label: "Jamaica", phone: "1876", currency: "JMD" },
  ...
  { code: "LA", label: "Laos", phone: "856", currency: "LAK" },
  ...
  { code: "MO", label: "Macao", phone: "853", currency: "MOP" },
  ...
  { code: "FM", label: "Micronesia", phone: "691", currency: "USD" },
  { code: "MD", label: "Moldova", phone: "373", currency: "MDL" },
  ...
  { code: "MS", label: "Montserrat", phone: "1664", currency: "XCD" },
  ...
  { code: "RU", label: "Russia", phone: "7", currency: "RUB" },
  ...
  { code: "SY", label: "Syria", phone: "963", currency: "SYP" },
  { code: "TW", label: "Taiwan", phone: "886", currency: "TWD" },
  { code: "TJ", label: "Tajikistan", phone: "992", currency: "TJS" },
  { code: "TZ", label: "Tanzania", phone: "255", currency: "TZS" },
  ...
  { code: "TK", label: "Tokelau", phone: "690", currency: "NZD" },
  ...
  { code: "VA", label: "Vatican City", phone: "379", currency: "EUR" },
  { code: "VE", label: "Venezuela", phone: "58", currency: "VES" },
  { code: "VN", label: "Vietnam", phone: "84", currency: "VND" },
  { code: "WF", label: "Wallis and Futuna", phone: "681", currency: "XPF" },
