...
const blogCardData: BlogCard[] = [
  {
    ...
    title: "ZAPTA: Your Trusted Partner for Software Development in the USA",
    description:
      "Discover ZAPTA , a leading software development company in the USA. We specialize in crafting custom solutions tailored to your unique business needs.",
    author: "Jane Doe",
    postedOn: "2023-10-05",
    rating: 5,
  ...
  },
  {
    ...
    title: "ZAPTA Technologies Expanding IT Services Globally in the USA",
    description:
      "Looking for top-notch IT services? ZAPTA Technologies is now serving the USA. Learn more about their expertise and commitment to excellence.",
    author: "John Smith",
    postedOn: "2023-09-20",
    rating: 5.0,
